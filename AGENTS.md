...
## Configuration Notes
The frontend dev server proxies `/api` to the Go server on port `8080`. Keep local config changes out of commits unless they are required for all contributors.
