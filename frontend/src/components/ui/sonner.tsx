...
const toastClassNames = {
  toast: cn(
    "group flex w-full max-w-[28rem] items-start gap-3 rounded-lg border bg-background p-3 text-foreground shadow-lg",
  ...
  title: "type-meta leading-5 font-medium tracking-[-0.01em] whitespace-normal break-words",
  description: "type-meta text-muted-foreground whitespace-normal break-words",
